  ...
  <body>
	...
	<div class="card" style="width: 18rem;">
	  ...
	  <div class="form-group">
		...
		<input name="desc" type="text" class="form-control" placeholder="Item Description">
		<label>Price</label>
		<input name="price" type="number" class="form-control" placeholder="Item Price">
		<label>Selly.gg ID</label>
		<input name="sellyid" type="number" class="form-control" placeholder="Item Selly ID">
	  </div>
